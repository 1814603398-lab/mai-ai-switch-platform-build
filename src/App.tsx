...
import { NewApiQuickSetup } from "@/components/new-api/NewApiQuickSetup";
import {
...
function App() {
  ...
  const addActionButtonClass =
    "maiai-add-provider-button bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white shadow-lg shadow-blue-500/25 dark:shadow-blue-500/40 rounded-full w-8 h-8";
  ...
  return (
    <div
      className="maiai-app flex flex-col h-screen overflow-hidden bg-background text-foreground selection:bg-primary/30 pb-4"
    ...
    >
      ...
      <header
        className="maiai-header fixed z-50 w-full transition-all duration-300 bg-background/80 backdrop-blur-md"
        {...DRAG_REGION_ATTR}
        style={
          {
            ...DRAG_REGION_STYLE,
      ...
      >
        <div
          className="maiai-header-inner flex h-full items-center justify-between gap-2 px-6"
          {...DRAG_REGION_ATTR}
            ...
            {currentView !== "providers" ? (
              <div className="flex items-center gap-2">
                <Button
                  ...
                  className={cn(
                    "maiai-back-button mr-2 rounded-lg",
                    managementBusy && "disabled:opacity-100",
                  )}
                >
                  <ArrowLeft className="w-4 h-4" />
                </Button>
                <h1 className="maiai-page-title text-lg font-semibold">
                  ...
                  {currentView === "new-api" && "快速配置"}
                </h1>
              </div>
            ) : (
              <div className="maiai-brand-lockup flex items-center gap-2">
                ...
                {currentView === "providers" && (
                  <>
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => setCurrentView("new-api")}
                      className="maiai-quick-config-button text-muted-foreground hover:bg-black/5 hover:text-foreground dark:hover:bg-white/5"
                      title="New API 一键配置"
                    >
                      <WandSparkles className="mr-1.5 h-4 w-4" />
                      <span className="hidden xl:inline">快速配置</span>
                    </Button>
      ...
      <main className="maiai-main flex-1 min-h-0 flex flex-col overflow-y-auto animate-fade-in">
