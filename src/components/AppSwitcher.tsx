...
export function AppSwitcher({
  ...
  return (
    <div
      ref={rootRef}
      className="maiai-app-switcher inline-flex bg-muted rounded-xl p-1 gap-1"
      ...
      {visibleList.map((app) => {
        ...
        return (
          <button
            ...
            className={cn(
              "maiai-app-switcher-item group inline-flex items-center gap-2 px-3 h-8 rounded-md text-sm font-medium transition-all duration-200",
              isActive
          ...
          >
            ...
            <span className="maiai-app-switcher-label truncate">
        ...
        <Popover open={moreOpen} onOpenChange={setMoreOpen}>
          <PopoverTrigger asChild>
            <button
              ...
              className={cn(
                "maiai-app-switcher-more inline-flex items-center px-3 h-8 rounded-md transition-all duration-200",
                moreOpen
                  ? "bg-background text-foreground shadow-sm"
                  : "text-muted-foreground hover:text-foreground hover:bg-background/50",
              )}
