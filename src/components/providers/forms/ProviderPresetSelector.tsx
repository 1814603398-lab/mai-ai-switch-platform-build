...
export function sortPresetEntries(
  ...
  if (sortMode === PresetSortMode.Original) {
    // Keep official integrations at the top and make the remaining utility
    // presets deterministic. Commercial metadata is intentionally ignored so
    // the selector does not promote partner entries.
