    ...
    const entries: TestPresetEntry[] = [
      ...presetEntries,
      {
        ...
        preset: {
          ...
          category: "aggregator",
          isPartner: true,
          partnerPromotionKey: "partner",
        },
      },
      {
        id: "official-with-metadata",
        preset: {
          name: "Official With Metadata",
          websiteUrl: "https://official.example.com",
          settingsConfig: {},
          category: "official",
          partnerPromotionKey: "official-provider",
        },
      },
    ];
