...
### 🌐 唯一官方网站：**[gitee.com/timimai/mai-ai-switch](https://gitee.com/timimai/mai-ai-switch)**
...
- **New API 一键配置** — 登录 New API 后自动读取可用模型和令牌；没有令牌时自动创建，然后一次性配置 Claude Code、Codex 和 OpenCode
...
从 [Releases](../../releases) 页面下载 Linux 压缩包。
