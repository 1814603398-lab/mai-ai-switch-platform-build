...
### 🌐 唯一の公式サイト：**[gitee.com/timimai/mai-ai-switch](https://gitee.com/timimai/mai-ai-switch)**
...
- **New API クイックセットアップ** -- New API にログインすると、利用可能なモデルとトークンを読み込み、必要ならトークンを作成して Claude Code、Codex、OpenCode をまとめて設定
...
Linux パッケージは [Releases](../../releases) からダウンロードしてください。
