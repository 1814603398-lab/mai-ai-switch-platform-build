...
### 🌐 The Only Official Website: **[gitee.com/timimai/mai-ai-switch](https://gitee.com/timimai/mai-ai-switch)**
...
- **New API Quick Setup** — Sign in to your New API account, read available models and tokens, create a token when needed, then configure Claude Code, Codex, and OpenCode in one flow
...
Download the Linux archive from the [Releases](../../releases) page.
