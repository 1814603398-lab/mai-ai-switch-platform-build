    ...
    let builder = builder
        ...
        .setup(|app| {
            ...
            // 初始化日志（输出到 <app_config_dir>/logs/cc-switch.log）
            {
                ...
                log::info!("=== MaiAI Switch v{} started ===", env!("CARGO_PKG_VERSION"));
            }
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // New API account and token workflow
            commands::new_api_login,
            commands::new_api_login_2fa,
            commands::new_api_get_self,
            commands::new_api_generate_access_token,
            commands::new_api_list_tokens,
            commands::new_api_reveal_token_key,
            commands::new_api_get_models,
            commands::new_api_create_token,
...
fn show_migration_error_dialog(app: &tauri::AppHandle, error: &str) -> bool {
    ...
    let message = if is_chinese_locale() {
        ...
        format!(
            ...
            Consider rolling back to an older MaiAI Switch version.\n\n\
...
fn show_database_init_error_dialog(
    ...
    let message = if is_chinese_locale() {
        ...
        format!(
            ...
            2) If you see “database version is newer”, please upgrade MaiAI Switch\n\
